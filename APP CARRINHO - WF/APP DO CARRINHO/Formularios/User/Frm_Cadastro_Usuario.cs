...
namespace APP_DO_CARRINHO.Formularios.User
{
    public partial class Frm_Cadastro_Usuario : Form
    {
        ...
        private void Btn_Confirmar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ControleSalvarIncluirUser)
                {
                    ...
                    //AppCarrinhoWFBiblioteca.Users.User user = LeituraFormulario();
                    //Valida os dados
                    //user.ValidarClass();
        ...
        //AppCarrinhoWFBiblioteca.Users.User LeituraFormulario()
        //{
        //    int idSituacao = Cbox_Situacao.SelectedIndex + 1;
        //    int idTipo = Cbox_Tipo.SelectedIndex + 1;

        //    AppCarrinhoWFBiblioteca.Users.User user = new AppCarrinhoWFBiblioteca.Users.User
        //    {
        //        Id = Txt_Id.Text,
